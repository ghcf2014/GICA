...
<div class="dl_cont_out">
	<form class="login-form" action="/Home/User/login.html" method="post" id="form">
		<div class="dl_cont" >
			<!--<p class="dl_top01" style="width: 800px;height: 40px;background: url(/Public/Home/images/denglu_bg01.png) repeat-x left top;text-align: center;line-height: 40px;font-size: 20px;color: #fff;font-family: '黑体';">登 录</p>
            <h2 class="dl_top02" style="width: 800px;height: 87px;background: url(/Public/Home/images/denglu_bg.png) no-repeat center top;"></h2>-->
			<div class="dl_cont_in" style="overflow: hidden;position: relative;min-height: 600px;">
				...
				<div class="dl_cont_l" style="width: auto; height: auto;float: right;border: 1px solid #ddd;background: rgba(255,255,255,0.3);padding: 40px 0 0;position: absolute;right: 130px;top: 40px;z-index: 10;box-shadow: 3px 3px 5px #ddd;">
					...
					<dl style="width: 300px;padding-left: 31px; margin-bottom: 0px;">
						<div>
							<img src="/Public/Home/images/yanzheng.png"> <input
								...
								class="verifyimg reloadverify vtip" src="<?php echo U('verify');?>" width="101"
								height="44" alt="点击切换"
					...
					<input type="large button blue" value="登&nbsp;&nbsp;&nbsp;&nbsp;录" name="denglu" id="loginIn"
						onclick="javascript:;" class="large button blue"  style="margin-left: 53px;font-size: 18px;width: 250px;
height: 50px;"/>
					<div class="dl_cont_bot" style="margin-left: 0px;">
						<span class="right"><a href="<?php echo U('System/findpassword');?>">忘记密码？</a><a
				...
				<div class="dl_cont_bg">
					<ul>
						<li style="background: url(/Public/Home/images/dl_cont_bg01.jpg) no-repeat 10px top;z-index: 1;"></li>
						<li style="background: url(/Public/Home/images/dl_cont_bg02.jpg) no-repeat 80px top;display: none;"></li>
						<li style="background: url(/Public/Home/images/dl_cont_bg03.jpg) no-repeat 100px top;display: none;"></li>
					</ul>
				</div>
				
				
				<!--中间-->
				<!--<div class="dl_cont_c" style="float: left;width:2px; min-height:325px;background: url(/Public/Home/images/denglu_bg02.png) repeat-y;margin-left: 49px;"></div>-->
				
				<!--右边-->
				<!--<div class="dl_cont_r" style="width: 250px;height:auto;float: right;padding-right: 80px;">
            		<div style="height: 250px;"><img src="/Public/Home/images/weixin_eweima.jpg" width="250" height="250"/></div>
