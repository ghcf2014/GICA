	...
	<div class="zc_cont">
		...
		<form id="form" action="/index.php?s=/Home/User/register.html" method="post">
			<div class="zc_cont_bot">		
				<!--左边-->
				<div class="zc_cont_bot_l">										
					<dl>
						<dt>
							<span>* </span>手机号码:
						</dt>
						<dd>
							<input id="mobile" type="text" value="" placeholder="请输入您的手机号码" name="mobile" class="txt" style="width:230px;" /><input id="zphone" type="button" value="点击获取验证码 " onClick="get_mobile_code();" class="yz" style="width:120px; float:right;" >
						</dd>
			...
			<dl>
				...
				<dd>
					<input type="text" size="8" name="mobile_code" placeholder="填写获取到的验证码" class="inputBg" style="width:130px;"/>
				</dd>
				<span id="checkphone" style="line-height:48px;"></span>
			</dl>
					<dl>
				...
				<div class="zc_cont_bot_r">
					<p>已有账户<a href="<?php echo U('User/login');?>">点击登录</a></p>
