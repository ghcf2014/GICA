...
<div class="sqjk_cont_out">
	<div class="sqjk_cont">
		...
		<div class="sqjk_cont_bot">
			...
			<div class="input_layout" style="width: 56%;float: left;" onload="setup();preselect('陕西省');promptinfo();">
				<h2>借款意向</h2>
				<dl>
				...
				<dl>
					<dt>所在地区</dt>
					<dd>
						<select class="select" name="province" id="s1" style="width: 28%;">
							<option></option>
						</select>
						<select class="select" name="city" id="s2" style="width: 28%;">
							<option></option>
						</select>
						<select class="select" name="town" id="s3" style="width: 32%;">
							<option></option>
						</select>
...
<script type="text/javascript">
   $('#apply_btn').click(function(){
	...
	$('#c_days').click(function(){
		...
		document.getElementById('day_time').style.display="block";
	});
	$('#c_month').click(function(){
		document.getElementById('year_time').style.display="none";
		document.getElementById('month_time').style.display="block";
		document.getElementById('day_time').style.display="none";
	});
	$('#c_year').click(function(){
		document.getElementById('year_time').style.display="block";
		document.getElementById('month_time').style.display="none";
		document.getElementById('day_time').style.display="none";
	});		
</script>
