...
<block name="body">
		...
		<form id="form" action="addBorrow.htm" method="post">
			<div class="nymain">
				<div class="bigbox" style="border: none">
					<div class="sqdk" style="background: none;">
						<div class="l-nav">
							<ul>
								<li>
									<a href="querBaseData.htm?from=1"><span>step1 </span> 基本资料</a>
								</li>
								<li>
									<a href="userPassData.htm?from=1"><span>step2 </span> 上传资料</a>
								</li>
								<li class="on last">
								...
								<div class="tab">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											...
											<td>
												<input name="paramMap.title" type="text" class="inp280"
													maxlength="20" value="${paramMap.title}" />
										...
										<tr>
											<td align="right">
												借款图片：
												<span class="fred">*</span>
												<input type="hidden" id="imgPath" name="paramMap.imgPath"
													value="${paramMap.imgPath}" />
											</td>
											<td>
												<input type="hidden" id="personalImg"
													value="${user.personalHead}" />
												<label>
													<input type="radio" name="radio" id="r_1" checked="checked"
														value="1" />
													上传借款图片
												</label>
												<label>
												...
												<span class="fred"><s:fielderror
														fieldName="paramMap['imgPath']"></s:fielderror>
												</span>
												<input type="hidden" id="radioval" name="paramMap.radioval"
													value="${paramMap.radioval}" />
											</td>
										</tr>
										<tr>
											<td align="right">
										...
										<tr>
											...
											<td>
												<span id="typeName" class="fred">${session.typeName}</span>
											</td>
										</tr>
										<tr>
											<td align="right">
											...
											<td class="tishi">
												<s:select list="borrowPurposeList" id="purpose"
													name="paramMap.purpose" cssClass="sel_140"
													listKey="selectValue" listValue="selectName" headerKey=""
													headerValue="--请选择--"></s:select>
												<span class="fred"><s:fielderror
														fieldName="paramMap['purpose']"></s:fielderror>
												</span>
											</td>
										</tr>
										<tr>
											...
											<td>
												<s:select list="borrowDeadlineMonthList" id="deadLine"
													name="paramMap.deadLine" cssClass="sel_140" listKey="key"
													listValue="value" headerKey="" headerValue="--请选择--"></s:select>
												<s:select list="borrowDeadlineDayList" id="deadDay"
												...
												<span class="fred"><s:fielderror
														fieldName="paramMap['deadLine']"></s:fielderror>
												</span>
											</td>
										</tr>
										<tr>
											...
											<td>
												<label>
													<s:checkbox name="paramMap.daythe" id="daythe" />
													&nbsp;置为天标
												</label>
											</td>
										</tr>
										<tr>
											...
											<td>
												<s:select id="paymentMode" name="paramMap.paymentMode"
													list="borrowRepayWayList" cssClass="sel_140" listKey="id"
													listValue="name" headerKey="" headerValue="--请选择--"></s:select>
												<span class="fred"><s:fielderror
														fieldName="paramMap['paymentMode']"></s:fielderror>
												</span>
											</td>
										</tr>
										<tr>
											...
											<td>
												<input type="text" id="amount" name="paramMap.amount"
													class="inp100x" value="${paramMap.amount}" />
												<span class="fred"><s:fielderror
														fieldName="paramMap['amount']"></s:fielderror>
												</span>
											</td>
										</tr>
										<tr>
											...
											<td>
												<input type="text" name="paramMap.annualRate" maxlength="5"
													value="${paramMap.annualRate}" class="inp100x" />
												%
												<span class="fred"><s:fielderror
														fieldName="paramMap['annualRate']"></s:fielderror>
												</span>
											</td>
										</tr>
										<s:if test="#request.subscribeStatus!=1">
											<tr>
												...
												<td>
													<s:select list="borrowMinAmountList"
														name="paramMap.minTenderedSum" cssClass="sel_140"
														listKey="key" listValue="value"></s:select>
													<span class="fred"><s:fielderror
															fieldName="paramMap['minTenderedSum']"></s:fielderror>
													</span>
												</td>
											</tr>
											<tr>
										...
										<s:else>
											...
											<td>
												<s:textfield name="paramMap.subscribe" cssClass="inp100x" />
												元
												<span class="fred"><s:fielderror
														fieldName="paramMap['subscribe']"></s:fielderror>
												</span>
												<input name="subscribeStatus" type="hidden"
													id="subscribeStatus" value="${subscribeStatus}" />
										...
										<tr>
											...
											<td>
												<input type="hidden" name="validateDay"
													value="${validateDay }" />
												...
												<s:else>
													<s:select list="borrowRaiseTermList" id="raiseTerm"
														...
														listValue="value" headerKey="" headerValue="--请选择--"></s:select>
													<span class="fred"><s:fielderror
															fieldName="paramMap['raiseTerm']"></s:fielderror>
													</span>
												</s:else>
										...
										<tr>
											...
											<td>
												<span class="fred"><s:fielderror
														fieldName="paramMap['detail']"></s:fielderror>
												</span>
										...
										<s:if test="#request.award_status==1">
											...
											<tr>
												<td align="right">
													&nbsp;
													<input type="hidden" name="award_status"
														value="${award_status }" />
													<input type="hidden" id="excitation"
														name="paramMap.excitationType"
														value="${paramMap.excitationType}" />
												</td>
												<td>
													<input type="radio" name="excitationType" checked="checked"
														id="radio_1" value="1" />
													不设置奖励
												</td>
											</tr>
											<tr>
												...
												<td>
													<input type="radio" name="excitationType" id="radio_2"
														value="2" />
													固定总额按投标比例分配奖励
													<input type="text" id="sum" name="paramMap.sum"
														value="${paramMap.sum}" class="inp100x gray"
														disabled="disabled" />
													元
													<span class="fred"><s:fielderror
															fieldName="paramMap['sum']"></s:fielderror>
													</span>
												</td>
											</tr>
											<tr>
												<td align="right">
													&nbsp;
													<input type="hidden" id="excitationMode"
														name="paramMap.excitationMode"
														value="${paramMap.excitationMode}" />
												</td>
												<td>
													<input type="radio" name="excitationType" id="radio_3"
														value="3" />
													借款总额百分比分配奖励
													<input type="text" id="sumRate" name="paramMap.sumRate"
														maxlength="20" value="${paramMap.sumRate}"
														class="inp100x gray" disabled="disabled" />
													%
													<span class="fred"><s:fielderror
															fieldName="paramMap['sumRate']"></s:fielderror>
													</span>
												</td>
											</tr>
										</s:if>
										<s:if test="#request.password_status == 1">
											...
											<tr>
												<td align="right">
													&nbsp;
													<input type="hidden" name="password_status"
												...
												<td>
													...
													&nbsp;
													<label>
														<s:checkbox id="hasPWD" name="paramMap.hasPWD" />
														&nbsp;有密码
													</label>
												</td>
											</tr>
											<tr>
												<td>
													<span class="fred"><s:fielderror
															fieldName="paramMap['investPWD']"></s:fielderror> </span>
												</td>
											</tr>
										</s:if>
										<tr>
										...
										<tr>
											...
											<td>
												<input type="text" class="inp100x" name="paramMap.code"
													id="code" />
												<img src="" title="点击更换验证码" style="cursor: pointer;"
													id="codeNum" width="46" height="18"
													onclick=
	javascript: switchCode();
/>
												<span class="fred"><s:fielderror
										...
										<tr>
											<td align="center" colspan="2">
												<span class="fred"><s:fielderror
														fieldName="paramMap['allError']"></s:fielderror>
												</span>
											</td>
										</tr>
										<tr>
	...
	function showdays() {
		...
		if (check == 'checked') {
			...
			$("#paymentMode").html("__tag_682$34_到期还本付息__tag_682$58_");
		} else {
