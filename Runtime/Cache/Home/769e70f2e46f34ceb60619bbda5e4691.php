			...
			<div class="cont_bot2">
				...
				<div class="cont_bot2_con">
					<?php if(is_array($list2)): $i = 0; $__LIST__ = $list2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="cont_bot2_con_in">
						...
						<div class="jdt">
							<p>进度</p>
							<span class="out"><span class="warning" style="width:<?php echo ($vo['has_borrow']/$vo['borrow_money']*100); ?>%;line-height:14px;color:white;text-align: center;"><?php echo ($vo['jindu']); ?>%</span></span>
						</div>
