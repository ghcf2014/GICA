...
<script type="text/javascript">
		...
		<div class="zh_cont_r">
			<h3>当前位置 > <span style="color: #D41010;">借款记录</span></h3>
			<div class="r_main">
				<div class="mes_con">
					<div class="tabtil">
					<ul>
						<li id="lab_1" class="on"><a
							href="<?php echo U('Member/Borrow/myborrowmanager');?>">全部的借款</a></li>
						<li id="lab_2"><a href="<?php echo U('Member/Borrow/checkingborrow');?>">审核中的借款</a></li>

						<li id="lab_3" ><a href="<?php echo U('Member/Borrow/issueborrow');?>">招标中的借款</a></li>
						<!--<li id="lab_4" onclick="jumpUrl('homeBorrowRecycledList.htm');">已回收的借款</li>
						<li id="lab_5" onclick="jumpUrl('homeBorrowBackAcountList.htm');">回账查询</li> -->
					...
					<div class="jkjl_search">
						...
						<div class="search_cont">
							<select class="search_type" >
								...
								<option value="7">新手体验标</option>
							</select>
							<div class="search_date" style="display: none;">
								<input type="text" class="search_date_txt" readonly="readonly" id="datechoose1"/>
								<span>—</span>
								<input type="text" class="search_date_txt" readonly="readonly"  id="datechoose2"/>
							</div>
						</div>
						...
						<div class="biaoge">
							<table width="98%" border="0" cellspacing="0" cellpadding="0">
								...
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td align="center"><?php echo ($vo["borrow_duration"]); ?>个月</td>
									<td align="center"><?php echo (date('Y-m-d',$vo["add_time"])); ?></td>
									<td align="center"><?php echo (date('Y-m-d',$vo["deadline"])); ?></td>
									<td align="center"><?php echo (get_borrow_type_name($vo["borrow_type"])); ?></td>
									<td align="center"><a href="<?php echo U('Member/Borrow/reimbursement?id='.$vo['id']);?>">还款</a><a href="<?php echo U('Invest/borrowprotocol?id='.$vo['id']);?>" target="_blank">|查看协议</a></td><?php endforeach; endif; else: echo "" ;endif; ?>
								</tr>
								<tr>
								<?php if($i == null): ?><td align="center" colspan="10">亲！你还没成功借过款哦。</td><?php endif; ?>
								</tr>
							</table>
							<div class="page">
...
<script type="text/javascript">
	$(function(){
		$('.box .jkjl_search .search').change(function(e){
			
			var txt=$(this).val();
			if(txt == 0)
			{
				//alert(1);width: 450px;height: 50px;padding-left: 475px;
				$('.box .jkjl_search').css({'width':'325px','padding-left':'565px'});
				$('.box .jkjl_search .search_cont .search_type').show().siblings().hide();
			}
			else
			{
				$('.box .jkjl_search').css({'width':'450px','padding-left':'440px'});
				$('.box .jkjl_search .search_cont .search_date').show().siblings().hide();
			}
		})
		
		$( "#datechoose1,#datechoose2" ).datepicker();
	})
