...
<block name="body">
	...
	<div class="zh_cont_out">
    	<div class="zh_cont">
            ...
            <div class="zh_cont_l">
                <ul>
                    <li class="current"><a class="current" href="<?php echo U('Member/Index');?>">个人中心</a></li>
 ...
 <!--zh_cont_r-->
            ...
            <div class="zh_cont_r">
                ...
                <ul class="ul01">
                    ...
                    <li><?php if($vs["phone_status"] == 0): ?><a href="<?php echo U('Userinfo/userchangephone');?>"><img
                ...
                <div class="zh_cont_r_bot">
                	<p>投资总汇</p><?php if(is_array($list2)): $i = 0; $__LIST__ = $list2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list2): $mod = ($i % 2 );++$i;?><ul>
                    	<li><p>待收总额：￥<?php if($vo["account_money"] != ''): echo ($list2['investor_capital']); ?>
										<?php elseif($vo["account_money"] == 1): ?>
										0<?php endif; ?></li>
