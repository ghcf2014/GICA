								...
								<s:else>
									<s:iterator value="pageBean.page" var="bean">
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
											...
											<td align="center"><a
												href="<?php echo U('Home/borrow/detail?id='.$vo['id']);?>"><?php echo ($vo["borrow_name"]); ?></a>
											</td>
											<td align="center"><?php echo ($vo["borrow_money"]); ?></td>
											<!-- <td align="center"><?php echo ($vo["repayment_type"]); ?>
												</td> -->
											<td align="center"><?php echo ($vo["has_borrow"]); ?></td>
											<td align="center"><?php echo ($vo["borrow_interest_rate"]); ?>%</td>
											...
											<td align="center"><?php if($vo["borrow_type"] == '1'): ?>净值 <?php elseif($vo["borrow_type"] == 2): ?> 秒还 <?php elseif($vo["borrow_type"] == 4): ?> 普通 <?php elseif($vo["borrow_type"] == 5): ?> 实地 <?php elseif($vo["borrow_type"] == 6): ?> 担保<?php endif; ?></td>
											<td align="center"><a
												href="<?php echo U('Invest/borrowprotocol?id='.$vo['id']);?>"
												target="_blank">查看协议</a></td><?php endforeach; endif; else: echo "" ;endif; ?>
										</tr>
									</s:iterator>
								</s:else>
							</table>
