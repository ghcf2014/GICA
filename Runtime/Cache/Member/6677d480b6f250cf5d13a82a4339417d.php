...
<script type="text/javascript">
		...
		<div class="zh_cont_r">
			<h3>当前位置 > <span>申请记录</span> > <span style="color: #D41010;">审核中的申请</span></h3>
			<div class="r_main">
				<div class="mes_con">
									<div class="tabtil">
					<ul>
						...
						<li id="lab_2" class="on"><a href="<?php echo U('Member/Borrow/checkingapply');?>">审核中的申请</a></li>
						<li id="lab_3" ><a href="<?php echo U('Member/Borrow/passapply');?>">
							已通过的申请</a></li>
						<li id="lab_3" ><a href="<?php echo U('Member/Borrow/overapply');?>">
							已完成的申请</a></li>
						...
						<div class="biaoge">
							<table class="bordered">
								...
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$chkdata): $mod = ($i % 2 );++$i;?><tr>
									...
									<td >
										<?php if($chkdata["time_type"] == '1'): echo ($chkdata["year_time"]); ?>年 
										<?php elseif($chkdata["time_type"] == 2): echo ($chkdata["month_time"]); ?>个月 
										<?php elseif($chkdata["time_type"] == 3): echo ($chkdata["day_time"]); ?>天<?php endif; ?>
									</td>
									<td >
									...
									<td >审核中</td><?php endforeach; endif; else: echo "" ;endif; ?>
								</tr>
								<tr>
								<?php if($i == null): ?><td >亲！你还没成功借过款哦。</td><?php endif; ?>
								</tr>
							</table>
