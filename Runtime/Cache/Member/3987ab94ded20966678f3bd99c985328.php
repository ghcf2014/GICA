            ...
            <div class="zh_cont_r"><?php if(is_array($mlist)): $i = 0; $__LIST__ = $mlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!--基本认证-->
                <div class="tab">
                    <form action="<?php echo U('add?id='.$vb['id']);?>" method="post">
                        <h3>当前位置 > <span style="color:#D41010;">基本认证</span></h3>
                        <div class="jbrz_con">
                        	<p class="warning"><b style="font-weight: normal;color: #b30000;">注意：</b>请填写真实有效的信息，一旦通过实名认证以下信息将不能修改</p>
                        	<dl class="jbrz">
                                <dt>手机号码</dt>
                                <dd><div class="txt" readonly id="idNo"><?php echo ($vo["cell_phone"]); ?></div></dd>
                            </dl>

                            <dl class="jbrz">
                        		<dt>真实姓名</dt>
                                <?php if($vo["real_name"] == null): ?><dd><input type="text" class="txt" name="real_name" id="realName" /></dd>
                                <?php else: ?>
                                    <dd><div class="txt" name="real_name" id="realName"><?php echo ($vo["real_name"]); ?></div></dd><?php endif; ?>
                        	</dl>
                        
	                        <dl class="jbrz">
	                        	<dt>身份证</dt>
                                <?php if($vo["real_name"] == null): ?><dd><input type="text" class="txt" name="idcard" id="idNo"/></dd>
                                <?php else: ?>
                                    <dd><div class="txt" name="idcard" id="idNo"><?php echo ($vo["idcard"]); ?></div></dd><?php endif; ?>
	                        </dl>                      
	                        ...
	                        <dl class="jbrz sex">
	                            ...
	                            <dd><?php if($vo["sex"] == '1'): ?>男<input type="radio" class="radio" name="sex" value="1" checked="checked"/>
	                                ...
	                                <?php else: ?>
	                                    男<input type="radio" class="radio" name="sex" value="1" />
	                                    女<input type="radio" class="radio" name="sex" value="0"/><?php endif; ?>
	                            </dd>
	                        </dl>
                        ...
                        <dl class="jbrz">
                        	<dt>职业</dt>
                            <dd>
                            <?php if($vo["zy"] == null): ?><select name="zy"  class="inp50" style="font-size: 16px;height: 40px;">                                
                                       <option>----请选择----</option>    
                                ...
                                <?php else: ?>
                                    <div class="txt" name="idcard" id="idNo"><?php echo ($vo["zy"]); ?></div><?php endif; ?>                            
                            </dd>
                        </dl>
                        ...
                        <dl class="jbrz">
                        	<dt>教育</dt>
                            <dd>
                            <?php if($vo["zy"] == null): ?><select name="education"  class="inp50" style="font-size: 16px;height: 40px;">                                
                                       <option >----请选择----</option>    
                                ...
                                <?php else: ?>
                                    <div class="txt" name="idcard" id="idNo"><?php echo ($vo["education"]); ?></div><?php endif; ?>                            
                            </dd>
                            
                        </dl>
                        
                        <dl class="jbrz adress">
                        	<dt>现居地址</dt>
                            <dd>
                                <?php if($vo["province_now"] == null): ?><select class="select" name="province_now" id="s1">
                                        <option></option>
                                    </select>
                                    <select class="select" name="city_now" id="s2">
                                        <option></option>
                                    </select>
                                    <select class="select" name="area_now" id="s3">
                                        <option></option>
                                    </select>
                                    
                                <?php else: ?>
                                    <div class="txt" name="idcard" id="idNo"><?php echo ($vo["province_now"]); ?>--<?php echo ($vo["city_now"]); ?>--<?php echo ($vo["area_now"]); ?></div><?php endif; ?>                              
                            </dd>
                        </dl>
                        <p class="wxts"><b style="font-weight: normal;color: red;">温馨提示：</b>我们将严格对用户的所有资料进行保密。</p>
