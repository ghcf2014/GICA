...
<div class="zh_cont_l">
	...
	<ul>
		<li style="color: #ef681f; overflow: hidden; background: url(/Public/Home/images/zh_cont_l_ul_li_bg.png) no-repeat left 15px; height: 72px;"	class="head"><a  href="javascript:;" style="color: #fff; display: block; width: 114px; height: 56px; line-height: 50px; border-top: 1px solid #ddd; padding-top: 15px; float: right;cursor: auto;">个人中心</a></li>
	...
	<ul>
		...
		<li><a href="">资金明细</a></li>
		<li><a href="<?php echo U('Userinfo/userbankset');?>">银行卡设置</a></li>
		<li><a href="<?php echo U('Userinfo/userchagerwithdraw');?>">充值提现</a></li>
	</ul>
...
<!--zh_cont_r-->
		...
		<div class="zh_cont_r">
			<h3 style="border-bottom: 1px solid #ddd;">
				当前位置 > <span style="color: #D41010;">我的借款</span>>><span style="color: #D41010;">已完成的申请</span>
			</h3>
			<div class="r_main">
				<div class="tabtil">
					<ul>
						...
						<div class="biaoge">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$chkdata): $mod = ($i % 2 );++$i;?><tr>
									<td align="center" class="b0"><?php echo ($i); ?></td>
									<td align="center" class="b1"><?php echo ($chkdata["borrow_money"]); ?></td>
									<td align="center" class="b2"><?php echo ($chkdata["borrow_duration"]); ?>
										<?php if($chkdata["time_type"] == '1'): ?>年 
										<?php elseif($chkdata["time_type"] == 2): ?> 个月 
										<?php elseif($chkdata["time_type"] == 3): ?> 天<?php endif; ?>
									</td>
									<td align="center" class="b3">
									...
									<td class="b4"><?php echo ($chkdata["borrow_info"]); ?></td>
									<td align="center" class="b5"><?php echo ($chkdata["apply_time"]); ?></td>
									<td align="center" style="width:10%;">已完成</td><?php endforeach; endif; else: echo "" ;endif; ?>
								</tr>
								<tr>
								<?php if($i == null): ?><td align="center" colspan="10">亲！你还没有成功申请过借款哦！</td><?php endif; ?>
								</tr>
							</table>
							<div class="page"></div>
						</div>
