					...
					<div class="box">
						<div class="boxmain2">
							<p class="tips">
								...
								4、处罚包括但不限于以下几种方式：<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;限制收款、冻结账户、永久停止服务，并对相关信用记录有影响。
							</p>
						</div>
						<!--biaoge2 end-->
						<div style="padding-left: 50px;">
							<section class="input_layout">
							    <!-- <form class="demo form-horizontal" id="demo1" action="#" method="post"> -->
							        <dl>
							            <dt><strong>充值金额</strong></dt>

							            <dd><input type="text" name="account_money" id="money"  style="width:150px;"><span class="form-error">不能填写数字以外的字符，以及负数。</span></dd>
							        </dl>
							        <dl>
							            <dt></dt>
							            <dd><p class="form-des">* 请尽可能整额充值</p></dd>
							        </dl>
							        <dl>
							            <dt><strong>充值方式</strong></dt>

							            <dd>
							                <input type="radio" name="pay" value="2" checked="checked"/>
											<img src="/Public/Home/images/banks/bank_31.png"width="128" height="33" title="汇潮支付" />
							                <input type="radio" name="pay" id="xxpay" value="3"  /> &nbsp;线下充值<span class="form-des">(需要提交转账凭证给客服核实)</span>
							            </dd>
							        </dl>
							        <dl>
							        	<dt><strong>操作卡号</strong></dt>
							        	<dd>
							        		<select name="banks" id="momeyType"  style="width:80%;">
												<option value="">--请选择--</option>
												<option value="<?php echo ($banksdata['bank_num']); ?>"><?php echo ($banksdata['bank_num']); ?>/<?php echo ($memberdata['real_name']); ?>/<?php echo ($banksdata['bank_name']); ?></option>
											</select>
							        	</dd>
							        </dl>
							         <dl>
							        	...
							        	<dd>
							        		<div id="btn_submit">
											<input type="button" class="large button blue r_post" name="b1" value="充值"  >
											</div>
							        	</dd>
							        </dl>
